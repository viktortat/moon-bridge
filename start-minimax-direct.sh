...
MB_CONFIG_TPL="$SCRIPT_DIR/config_MM_direct.yml"
...
echo "Starting Moon Bridge (MiniMax-M3 via MiniMax Anthropic API)..."
...
echo "Moon Bridge started. Config switched to MiniMax-M3 (direct MiniMax API). Codex is ready."
