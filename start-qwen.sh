...
MB_CONFIG_TPL="$SCRIPT_DIR/config_QW.yml"
MB_CONFIG="$SCRIPT_DIR/.config-active.yml"
CODEX_HOME="${CODEX_HOME:-$HOME/.codex}"
MODEL_CONF="$SCRIPT_DIR/config.toml.qwen"
...
echo "Starting Moon Bridge (qwen/qwen3.7-max via OpenRouter)..."
...
echo "Moon Bridge started. Config switched to Qwen3.7-Max (OpenRouter). Codex is ready."
