...
MB_CONFIG_TPL="$SCRIPT_DIR/config_DS.yml"
MB_CONFIG="$SCRIPT_DIR/.config-active.yml"
CODEX_HOME="${CODEX_HOME:-$HOME/.codex}"
MODEL_CONF="$SCRIPT_DIR/config.toml.deepseek"
...
echo "Starting Moon Bridge (deepseek-v4-flash)..."
...
echo "Moon Bridge started. Config switched to DeepSeek V4 Flash. Codex is ready."
